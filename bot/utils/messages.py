...
MESSAGES = {
    ...
    'CHOOSE_QUIZ': 'Выберите тестирования',
    ...
    'START_REFERAL': 'Ваша реферальная ссылка: {}\n\nВ вашей структуре на текущий момент число пользователей: <b>{}</b>',
    ...
    'ERROR_IN_HANDLER': 'Произошла непредвиденная ошибка! Пожалуйста отправьте отчет об ошибке: @justagreeny\nСообщите свой id: <b>{}</b>',
    'SUPPORT': 'Напишите пользователю @justagreeny ваш вопрос',
    'END_TEST_PERIOD': 'Ваш тестовый период закончился! Свяжитесь с службой поддержки @justagreeny',
    'GO_TO_TEST_PROMOCODE': 'Поздравляем!Вы успешно активировали пробный период бота <b>Реалогика</b>',
    'TEST_PROMO_MENU': 'Меню',
    'START_ANKETA': 'У вас есть неотвеченные вопросы в анкете! Пожалуйста уделите пару минут',
    'ANKETA_QUESTION': 'Вопрос: <b>{}</b>',
    'WRITE_YOUR_ANKETA_ANSWER': 'Напишите свой ответ',
}
